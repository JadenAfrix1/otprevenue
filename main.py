...
class TelegramOTPFetcher:
    ...
    async def status(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            f'✅ *Bot Status: Active*\n\n'
            f'🤖 Bot: @@astraxotp_bot\n'
            f'💬 Monitoring: https://t.me/afrixotpgc\n'
    ...
    def format_phone_number(self, phone_number):
        ...
        return self.mask_number(phone_number)
    ...
    async def send_success_numbers_to_group(self):
        ...
        try:
            ...
            for number in new_numbers:
                ...
                keyboard = [
                    [
                        InlineKeyboardButton("Bot", url=f"https://t.me/astraxotp_bot"),
                        InlineKeyboardButton("Group", url="https://t.me/afrixotpgc")
                    ]
                ]
        ...
        if update.message and update.message.text:
            ...
            if chat_id == self.chat_id:
                ...
                if otp:
                    ...
                    # Create response message using .format()
                    response = (
                        "📬 \"{}\" OTP Detected\\!\n\n"
                        "Number: `{}`\n"
                        "🔐OTP: `{}`\n"
                        ...
                        self.escape_markdown(application_name),
                        self.escape_markdown(formatted_number),
                        self.escape_markdown(otp),
                        self.escape_markdown(country),
                        self.escape_markdown(current_time),
                        self.escape_markdown(message_text)
                    )
...
if __name__ == '__main__':
    ...
    bot = TelegramOTPFetcher(
        bot_token="8564326706:AAHP-uIJwe4swR6pZD4VO2QarsxOvCuznZg",
